...
def addStudent():
    ...
    cur.execute("INSERT INTO attendance( student_id, subject_id, total) VALUES (%s, %s, %s)", ( student_id, 1, 0))
    db.commit()
    cur.execute("INSERT INTO attendance( student_id, subject_id, total) VALUES (%s, %s, %s)", ( student_id, 2, 0))
    db.commit()
    cur.execute("INSERT INTO attendance( student_id, subject_id, total) VALUES (%s, %s, %s)", ( student_id, 3, 0))
    db.commit()
    cur.execute("INSERT INTO attendance( student_id, subject_id, total) VALUES (%s, %s, %s)", ( student_id, 4, 0))
    db.commit()
